...
for var in model.variables():
    if var.name.startswith("n_") or var.name.startswith("x_") or var.name.startswith("l_"):
        if not non_zero_only or var.varValue != 0:
...
print(f"average income for each scenario is : {value((objective_part1 + objective_part2 + objective_part3)/3):.2f}")
...
#             Scenario 1, Route 1, train type 3 : 0.43
# Scenario 1, Route 1, train type 4: 0.29
# Scenario 1, Route 1, train type 5: 0.29
# Scenario 1, Route 2, train type 3 : 1.00
# Scenario 1, Route 2, train type 4: 0.00
# Scenario 1, Route 2, train type 5: 0.00
# Scenario 1, Route 3, train type 3 : 1.00
# Scenario 1, Route 3, train type 4: 0.00
# Scenario 1, Route 3, train type 5: 0.00
# Scenario 1, Route 4, train type 3 : 0.27
# Scenario 1, Route 4, train type 4: 0.36
# Scenario 1, Route 4, train type 5: 0.36
# Scenario 1, Route 5, train type 3 : 0.36
# Scenario 1, Route 5, train type 4: 0.32
# Scenario 1, Route 5, train type 5: 0.32
# Scenario 2, Route 1, train type 3 : 0.36
# Scenario 2, Route 1, train type 4: 0.32
# Scenario 2, Route 1, train type 5: 0.32
# Scenario 2, Route 2, train type 3 : 0.36
# Scenario 2, Route 2, train type 4: 0.32
# Scenario 2, Route 2, train type 5: 0.32
# Scenario 2, Route 3, train type 3 : 0.47
# Scenario 2, Route 3, train type 4: 0.32
# Scenario 2, Route 3, train type 5: 0.21
# Scenario 2, Route 4, train type 3 : 0.43
# Scenario 2, Route 4, train type 4: 0.29
# Scenario 2, Route 4, train type 5: 0.29
# Scenario 2, Route 5, train type 3 : 0.36
# Scenario 2, Route 5, train type 4: 0.32
# Scenario 2, Route 5, train type 5: 0.32
# Scenario 3, Route 1, train type 3 : 0.53
# Scenario 3, Route 1, train type 4: 0.24
# Scenario 3, Route 1, train type 5: 0.24
# Scenario 3, Route 2, train type 3 : 1.00
# Scenario 3, Route 2, train type 4: 0.00
# Scenario 3, Route 2, train type 5: 0.00
# Scenario 3, Route 3, train type 3 : 1.00
# Scenario 3, Route 3, train type 4: 0.00
# Scenario 3, Route 3, train type 5: 0.00
# Scenario 3, Route 4, train type 3 : 0.43
# Scenario 3, Route 4, train type 4: 0.29
# Scenario 3, Route 4, train type 5: 0.29
# Scenario 3, Route 5, train type 3 : 0.43
# Scenario 3, Route 5, train type 4: 0.19
# Scenario 3, Route 5, train type 5: 0.38